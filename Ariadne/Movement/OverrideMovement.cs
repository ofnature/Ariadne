...
// Vendored from vnavmesh (external/ffxiv_navmesh/vnavmesh/Movement/OverrideMovement.cs).
// Signature-scanned game interop — kept verbatim apart from the Service class; re-check
// against upstream on every game patch (signatures are the first thing to break).
