...
// Vendored from vnavmesh (external/ffxiv_navmesh/vnavmesh/SceneDefinition.cs), verbatim
// apart from the namespace. This is the full capture (not the festival/SG "scene-lite"
// in ZoneKey): everything Mnemosyne's out-of-process builder needs to reproduce the
// exact live variant of a zone — instances, transforms, collision paths, festival
// layers, shared-group states. Must run on the framework thread.
//
